...
parent_dir='/lustre/fsstor/projects/rech/vfh/uki35ex/_Experiments/GroupedNewton2_results'
expe_series='MLP_MNIST_GrNewt2_01_Tests'
...
HYDRA_FULL_ERROR=1 OC_CAUSE=1 python main_hydra.py --multirun hydra/launcher=submitit_slurm\
                ...
                hydra.launcher.account='vfh@v100'\
